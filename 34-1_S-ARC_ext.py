...
def save_altair_chart(chart, file_base):
    ...
    chart.save(str(PLOTS_DIR / f"{file_base}.png"), scale_factor=2)
...
save_altair_chart(plot1, "figure06a")
save_altair_chart(plot2, "figure06b")
save_altair_chart(plot3, "figure06c")
...
save_altair_chart(plotA, "figure07a")
save_altair_chart(plotB, "figure07b")
save_altair_chart(plotC, "figure07c")
